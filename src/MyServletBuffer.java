...
public class MyServletBuffer extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // 아파치/톰캣은 TCP에 연결된 소켓으로 정보를 읽어들인다.
        // 읽어들인 정보를 다시 Servlet.java 파일에 넘겨주는데 크게 두 분류로 나뉜다.
        // 1. header 정보
        // 2. body 정보 (body 정보는 getReader()를 통해서 읽는다.)
        BufferedReader br = req.getReader();  // 이 버퍼는 소켓 버퍼를 읽는게 아니라, 아파치/톰캣이 만든 버퍼에 접근
